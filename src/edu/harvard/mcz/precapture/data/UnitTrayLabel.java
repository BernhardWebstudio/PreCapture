...
public class UnitTrayLabel implements TaxonNameReturner {
	...
	public UnitTrayLabel(Long id, String drawerNumber, String family, String subfamily,
			...
			String authorship, String unnamedForm, int printed, Date dateCreated, Date dateLastUpdated, String collection, String identifiedBy, Integer ordinal) {
		super();
		this.id = id;
			...
			if (jsonEncodedLabel.contains("}")) { 
			    ...
			    for (int x=0; x< pairs.length; x++) {
			    	...
			    	if (keyValuePair.length==2) { 
			    		...
			    		if (key.equals("id")) { result.setIdentifiedBy(value); }
			    	}
			    }
		    }
	    } else {
